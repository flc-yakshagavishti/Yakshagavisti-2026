...
const reelImags = [
  {
    src: "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934707/Yakshagavishti/yakshagavishti/assets/home/reel/1.jpg",
  },
  {
    src: "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934709/Yakshagavishti/yakshagavishti/assets/home/reel/2.jpg",
  },
  {
    src: "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934712/Yakshagavishti/yakshagavishti/assets/home/reel/3.jpg",
  },
  {
    src: "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934714/Yakshagavishti/yakshagavishti/assets/home/reel/4.jpg",
  },
  {
    src: "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934718/Yakshagavishti/yakshagavishti/assets/home/reel/5.jpg",
  },
  {
    src: "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934720/Yakshagavishti/yakshagavishti/assets/home/reel/6.jpg",
  },
  {
    src: "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934723/Yakshagavishti/yakshagavishti/assets/home/reel/7.jpg",
  },
  {
    src: "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934726/Yakshagavishti/yakshagavishti/assets/home/reel/8.jpg",
  },
];
    ...
    <>
      <div ref={mainRef} className="flex flex-col gap-10 pb-20 md:gap-20">
        ...
        <section className="bg-image-gradient relative mt-1 flex h-screen w-full flex-col items-center justify-end overflow-y-hidden">
          <Image
            src={
              "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934729/Yakshagavishti/yakshagavishti/assets/home/Gavishti_background.png"
            }
            alt="Banner"
          ...
          <div className="mx-4 flex max-w-7xl flex-col items-center gap-14 sm:mx-8 lg:mx-32 landscape:short:gap-8">
            ...
            <Image
              src={
                "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934735/Yakshagavishti/yakshagavishti/assets/home/Gavishti_mobile_background.png"
              }
              alt="Background Image"
            ...
            <div className="absolute bottom-24 left-0 right-0 -z-10 h-screen w-full overflow-hidden sm:hidden short:bottom-0">
              <Image
                src={
                  "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934739/Yakshagavishti/yakshagavishti/assets/home/Layer_6.png"
                }
                height={300}
                width={300}
                alt=""
        ...
        <section className="relative mx-4 flex h-[60vh] items-start justify-center overflow-hidden sm:mx-8 sm:h-screen lg:mx-32">
          ...
          <Image
            ...
            src={
              "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934741/Yakshagavishti/yakshagavishti/assets/home/mandala-center.png"
            }
            fill
            alt="mandala"
          ></Image>
          {/* <ScrollLag
						...
						>
							<Image
								src={"https://res.cloudinary.com/dstpdenfa/image/upload/v1769934745/Yakshagavishti/yakshagavishti/assets/home/mandala.png"}
								fill
								alt=""
              ...
              <div className="flex shrink-0 flex-col items-center gap-3">
                <Reveal classes="">
                  <div className="group relative h-48 w-48 shrink-0 overflow-hidden rounded-xl border-secondary-100 drop-shadow-[0px_0px_12px_#df8b2b] transition duration-200 ease-linear hover:scale-105 sm:h-56 sm:w-56 lg:h-60 lg:w-60">
                    <Image
                      src={
                        "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934748/Yakshagavishti/yakshagavishti/assets/home/logo.png"
                      }
                      alt="Yakshagana"
                      fill
        ...
        <section className="relative mx-4 flex flex-col gap-3 sm:mx-8 sm:mt-48 md:mt-12 lg:mx-32 xl:mt-20 2xl:mt-0">
          ...
          >
            <div className="">
              <Image
                src={
                  "https://res.cloudinary.com/dstpdenfa/image/upload/v1769934745/Yakshagavishti/yakshagavishti/assets/home/mandala.png"
                }
                fill
                alt=""
