...
const team = () => {
  return (
    <div className="mt-[4.75rem] sm:mt-[5.75rem] md:mt-24 lg:mt-[6.25rem] min-h-[50vh] flex flex-col justify-center">
      <div className="m-10 py-5 flex items-center">
        <div className="container m-auto px-2 md:px-12 xl:px-6 flex justify-center">
            <div className="sm:mx-2 md:w-6/12 lg:mx-0 lg:w-6/12 flex flex-col gap-8 items-center">
              <Reveal classes="">
              ...
              <Reveal classes="flex justify-center items-center">
                <Image
                  src="https://res.cloudinary.com/dstpdenfa/image/upload/v1769934758/Yakshagavishti/yakshagavishti/assets/team/flc_logo.png"
                  alt="image"
                  height={300}
                  width={300}
