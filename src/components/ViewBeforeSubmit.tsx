...
export default function ViewBeforeSubmit({
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-h-[90%] overflow-y-scroll bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-gray-950/50 via-slate-900 to-black text-white sm:max-w-[425px]">
        <DialogHeader>
