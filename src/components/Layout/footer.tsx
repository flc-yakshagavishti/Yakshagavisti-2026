      ...
      <div className="relative flex flex-col items-center justify-center overflow-hidden text-base xl:text-lg gap-10 p-10 max-w-7xl xl:mx-auto">
        <div className="flex flex-col md:flex-row w-full justify-around items-center gap-5 md:gap-20">
          <div className="relative">
            <Link href={'/'}>
              <Image src={'https://res.cloudinary.com/dstpdenfa/image/upload/v1769934704/Yakshagavishti/yakshagavishti/assets/home/kalaasangamalogo.png'} alt="Logo" className="object-contain object-center w-20 md:w-24 lg:w-28 2xl:w-30" height={90} width={90} priority />
        ...
        <div className="text-base xl:text-lg text-center flex flex-col gap-2">
          ...
          <div className="">
            © <span className="text-secondary-100 font-medium">{f("Footer")}</span> 2026
          </div>
        </div>
      </div>
    </div>
